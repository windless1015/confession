...
;(function (window) 
{
  ...
  let texts = ['致你乐乐', '祝你生日快乐', '希望以后每一天', '你都可以开心', '这个网站和域名', '会一直存在', '说不定', '它会不定期更新', '你看似脾气不好', '有时还很强势', '但在我眼中','你真的很可爱', '这首致你送给你', '猜你启封', '的表情', '只敢写下开篇的', '致你', 'Happy Birthday', "LL"]
  ...
  function event () {
    ...
    {
        //if music is not playing, play music. if music is on, ignore
        if(!musicIsOn)
        {
            mp3.play()
            musicIsOn = true
